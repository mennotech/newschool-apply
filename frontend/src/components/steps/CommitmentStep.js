...
function buildAttributes(stepData) {
  ...
  const raw = {
    ...
    field_physical_address_line_1: studentInfo.physical_address_line_1,
    field_physical_address_line_2: studentInfo.physical_address_line_2,
    field_physical_city: studentInfo.physical_city,
    field_physical_state_province: studentInfo.physical_state_province,
    field_physical_postal_zip: studentInfo.physical_postal_zip,
